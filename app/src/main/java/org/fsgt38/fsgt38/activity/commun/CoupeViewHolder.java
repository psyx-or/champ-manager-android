...
public abstract class CoupeViewHolder<T> extends TableauViewHolder<T, Journee> {
	 ...
	 * @param equipe Equipe
	 */
	protected void affiche(Championnat championnat, Journee journee, Equipe equipe) {
